    ...
    <div class="line2 o2">
      ...
      <div class="box b3 share">
        ...
        <ul>
          ...
          <li class="twitter"><a href="https://twitter.com/intent/tweet?text=<?php echo $share_url; ?>%20-%20<?php _e('your', 'veronika'); ?>%20<?php _e('classifieds', 'veronika'); ?>" title="<?php echo osc_esc_html(__('Tweet us', 'veronika')); ?>" target="_blank"><i class="fab fa-twitter"></i></a></li>
