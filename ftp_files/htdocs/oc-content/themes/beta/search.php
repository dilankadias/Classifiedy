      ...
      <div class="wrap">
        ...
        <form action="<?php echo osc_base_url(true); ?>" method="get" class="search-side-form nocsrf" id="search-form">
          ...
          <div style="display:none;">
            <span class="hCurrentUrl"><?php echo $actual_link; ?></span>
          </div>
      ...
      <div id="search-sort" class="">
        ...
        <?php if(osc_count_items() > 0) { ?>
          <div class="list-grid">
            ...
            <a href="<?php echo osc_update_search_url(array('sShowAs' => 'list')); ?>" title="<?php echo osc_esc_html(__('List view', 'beta')); ?>" class="lg<?php echo ($show == 'list' ? ' active' : ''); ?>" data-view="list"><i class="fa fa-list-ul"></i></a>
            <a href="<?php echo osc_update_search_url(array('sShowAs' => 'grid')); ?>" title="<?php echo osc_esc_html(__('Grid view', 'beta')); ?>" class="lg<?php echo ($show == 'grid' ? ' active' : ''); ?>" data-view="grid"><i class="fa fa-th-large"></i></a>
          </div>
