  ...
  <div class="container">
    <section class="one">
      <div class="col contact">
        ...
        <p class="logo"><?php echo eps_logo(true); ?></p>
      ...
      <div class="col socialx">
        ...
        <a class="whatsapp" href="whatsapp://send?text=<?php echo $share_url; ?>" data-action="share/whatsapp/share"><i class="fab fa-whatsapp"></i> <?php _e('Whatsapp', 'epsilon'); ?></a>
        <a class="facebook" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $share_url; ?>" title="<?php echo osc_esc_html(__('Share us on Facebook', 'veronika')); ?>" target="_blank"><i class="fab fa-facebook-f"></i> <?php _e('Facebook', 'epsilon'); ?></a>
        <a class="pinterest" href="https://pinterest.com/pin/create/button/?url=<?php echo $share_url; ?>&media=<?php echo osc_base_url(); ?>oc-content/themes/<?php echo osc_current_web_theme(); ?>/images/logo.jpg&description=" title="<?php echo osc_esc_html(__('Share us on Pinterest', 'veronika')); ?>" target="_blank"><i class="fab fa-pinterest-p"></i> <?php _e('Pinterest', 'epsilon'); ?></a>
        <a class="twitter" href="https://twitter.com/home?status=<?php echo $share_url; ?>%20-%20<?php _e('your', 'veronika'); ?>%20<?php _e('classifieds', 'veronika'); ?>" title="<?php echo osc_esc_html(__('Tweet us', 'veronika')); ?>" target="_blank"><i class="fab fa-twitter"></i> <?php _e('Twitter', 'epsilon'); ?></a>
        <a class="linkedin" href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo $share_url; ?>&title=<?php echo osc_esc_html(__('My', 'veronika')); ?>%20<?php echo osc_esc_html(__('classifieds', 'veronika')); ?>&summary=&source=" title="<?php echo osc_esc_html(__('Share us on LinkedIn', 'veronika')); ?>" target="_blank"><i class="fab fa-linkedin"></i> <?php _e('LinkedIn', 'epsilon'); ?></a>
      </div>
