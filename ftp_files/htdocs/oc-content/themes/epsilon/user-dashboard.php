    ...
    <div id="user-main">
      <div class="headers">
        <a href="<?php echo osc_user_profile_url(); ?>" class="img-container" title="<?php echo osc_esc_html(__('Upload profile picture', 'epsilon')); ?>">
          <img src="<?php echo eps_profile_picture(osc_logged_user_id(), 'medium'); ?>" alt="<?php echo osc_esc_html(osc_logged_user_name()); ?>" width="36" height="36"/>
      ...
      <div class="card-box">
        <?php if(function_exists('bpr_call_after_install') && (bpr_param('only_company_users') == 0 || (bpr_param('only_company_users') == 1 && $user['b_company'] == 1))) { ?>
          <a class="card public" href="<?php echo bpr_company_url(osc_logged_user_id()); ?>">
            <div class="icon">
        ...
        <?php } else { ?>
          <a class="card public" href="<?php echo osc_user_public_profile_url(osc_logged_user_id()); ?>">
            <div class="icon">
        ...
        <?php if(function_exists('im_messages')) { ?>
          <a class="card messages" href="<?php echo osc_route_url('im-threads'); ?>">
            <div class="icon">
              ...
              <span class="count"><?php echo eps_count_messages(osc_logged_user_id()); ?></span>
            </div>
