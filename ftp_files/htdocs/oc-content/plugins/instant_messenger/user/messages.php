...
<?php 
  ...
  if(($thread['i_from_user_id'] == osc_logged_user_id() && osc_is_web_user_logged_in()) || ($secret == $thread['s_from_secret'])) {
    ...
    if($thread['i_to_user_id'] == NULL && $thread['s_to_user_email'] == NULL) {
      $target_is_null = true;
    }
  } else {
    ...
    if($thread['i_from_user_id'] == NULL && $thread['s_from_user_email'] == NULL) {
      $target_is_null = true;
    }
  }
