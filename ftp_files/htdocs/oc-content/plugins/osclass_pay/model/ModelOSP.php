...
// Used when moving user out of group
public function deactivateUserItemsAboveLimit($user_id, $email = '') {
...
public function updateUserGroup($user_id, $group_id, $expire = NULL) {
  ...
  $this->deactivateUserItemsAboveLimit($user_id);     // should make sense just for update
